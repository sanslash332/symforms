...
$template=$this->getDoctrine()->getRepository(FormTemplate::class)->find($question->getForm());



        if ($form->isSubmitted() && $form->isValid()) {
$question->setForm($template);
            $em = $this->getDoctrine()->getManager();
            $em->persist($question);
            $em->flush();

            return $this->redirectToRoute('formtemplate_show', array('id' => $question->getForm()->getId()));
        }
